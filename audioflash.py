...
if __name__ == "__main__":
    ...
    parser.add_argument("--use-spec", dest="use_spec", action="store_true")
    parser.add_argument("--long-legs", dest="long_legs", action="store_true")
    ...
    opts = {
        ...
        "use-spec": args.use_spec,
        "long-legs": args.long_legs,
    }
